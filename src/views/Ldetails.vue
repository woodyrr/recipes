    ...
    <main class=" w-full  text-[#E5E7EB] px-[2%] sm:px-[5%] md:px-[6%] 2xl:px-[8%] py-10">
        <section class=" flex flex-col gap-10">
            <div class="px-3 flex justify-between text-[12px] md:text-base text-[#394150] w-full">
                ...
                <router-link to="/search" class="flex gap-1 bg-white rounded-2xl items-center p-2 md:p-3">
            ...
            <div class="flex flex-col gap-10 w-full sm:px-[18%] 2xl:px-[25%]" v-for="item in food.meals">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex gap-4">
                        <router-link :to="/lcategory/ + item.strCategory"  class="flex bg-[#394150] px-4 py-2 rounded-full gap-1">
                            <div>category:</div>
                            <div class="font-bold"> {{ item.strCategory }}</div>
                        </router-link>
                        <router-link :to="/larea/ + item.strArea"  class="flex bg-[#394150] px-4 py-2 rounded-full gap-1">
                            <div>Area:</div>
